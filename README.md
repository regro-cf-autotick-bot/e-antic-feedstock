...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/e-antic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/e-antic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libeantic pyeantic
# for installing globally
pixi global install libeantic pyeantic
```
...
It is possible to list all of the versions of `libeantic` available on your platform:
...
```
pixi search libeantic --channel conda-forge
```
